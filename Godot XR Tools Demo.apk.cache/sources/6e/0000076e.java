...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1331elapsedNowUwyO8pc() {
        return Duration.m1374minusLRDsOJo(this.mark.mo1331elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1333plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1375plusLRDsOJo(this.adjustment, duration), null);
    }
}