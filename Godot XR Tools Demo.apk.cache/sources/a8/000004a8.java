        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m592contentEqualskV0jMPg(((UByteArray) t).m110unboximpl(), ((UByteArray) t2).m110unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m589contentEqualsFGO6Aew(((UShortArray) t).m370unboximpl(), ((UShortArray) t2).m370unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m590contentEqualsKJPZfPQ(((UIntArray) t).m188unboximpl(), ((UIntArray) t2).m188unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m594contentEqualslec5QzE(((ULongArray) t).m266unboximpl(), ((ULongArray) t2).m266unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m606contentToString2csIQuQ(uByteArray != null ? uByteArray.m110unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m610contentToStringd6D3K8(uShortArray != null ? uShortArray.m370unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m609contentToStringXUkPCBk(uIntArray != null ? uIntArray.m188unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m612contentToStringuLth9ew(uLongArray != null ? uLongArray.m266unboximpl() : null));
            } else {
