...
public final class UStringsKt {
    ...
    public static final String m1328toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1330toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1329toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1327toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m171unboximpl = uIntOrNull.m171unboximpl();
            if (UnsignedKt.uintCompare(m171unboximpl, UInt.m120constructorimpl(255)) > 0) {
                return null;
            }
            return UByte.m38boximpl(UByte.m44constructorimpl((byte) m171unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m171unboximpl = uIntOrNull.m171unboximpl();
            if (UnsignedKt.uintCompare(m171unboximpl, UInt.m120constructorimpl(SupportMenu.USER_MASK)) > 0) {
                return null;
            }
            return UShort.m298boximpl(UShort.m304constructorimpl((short) m171unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m120constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m373uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m120constructorimpl(result * uradix);
            result = UInt.m120constructorimpl(UInt.m120constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m114boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m198constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                if (limitBeforeMul == 512409557603043100L) {
                    limitBeforeMul = UnsignedKt.m375ulongDivideeb3DHEI(-1L, uradix);
                    if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                        return null;
                    }
                } else {
            ...
            long result2 = ULong.m198constructorimpl(result * uradix);
            result = ULong.m198constructorimpl(ULong.m198constructorimpl(UInt.m120constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m192boximpl(result);
    }
}